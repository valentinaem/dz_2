...
print('Привет,', (''.join(workers[0].split(' ')[-1])).title(), '!')
print('Привет,', (''.join(workers[1].split(' ')[-1])).title(), '!')
print('Привет,', (''.join(workers[2].split(' ')[-1])).title(), '!')
print('Привет,', (''.join(workers[3].split(' ')[-1])).title(), '!')